...
import { TableTwoStepSummary } from "./scripts/runtime/separateTableUpdate.js?v=memo88";
...
import { initRefreshTypeSelector } from './scripts/runtime/absoluteRefresh.js?v=memo88';
...
import { executeMemoTableEdit, restoreMemoSnapshot } from './scripts/runtime/safeTableExecutor.js?v=memo88';
...
jQuery(async () => {
    ...
    // 自用版：禁用公开仓库版本检查。
    $("#tableUpdateTag").hide();
    $("#table_message_tip").text("世界状态记忆表格 · 自用版");
