...
import { TableTwoStepSummary } from "./separateTableUpdate.js?v=memo86";
...
import { restoreMemoSnapshot } from "./safeTableExecutor.js?v=memo86";
...
export async function rebuildTableActions(force = false, silentUpdate = USER.tableBaseSetting.bool_silent_refresh, chatToBeUsed = '') {
    const { runStableCleanup } = await import('./stableTableCleanup.js?v=memo86');
